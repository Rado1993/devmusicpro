...
namespace musicback.Controllers
{
    ...
    {/// <summary>
     /// The bs
     /// </summary>
        private readonly Bussiness.Stocks _bs;
        ...
        {
            _bs = new Bussiness.Stocks(configuration);
        }
        ...
        {
            var opt = new CoreFilter<Stock>();
            if (filter != null)
            {
                var tmp = new CoreRequest() { Data = filter };
                opt = tmp.GetObject<CoreFilter<Stock>>();
            }
