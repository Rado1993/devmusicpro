...
export class HomeOrdenPedidoProps { }

export class HomeOrdenPedidoState {
  tipoUser?: string;
...
export class HomeOrdenPedido extends React.Component<HomeOrdenPedidoProps, HomeOrdenPedidoState>{
  constructor(props: any) {
    ...
    this.state = {
      ...
      venta: [],
      pedido: false,
      //4: 'Generada', 7: 'Aceptada', 8: 'Despachada'
      estados: [
        {
          key: 4,
          text: "Generada"
  ...
  public obtenerVentas() {
    ...
    CompraService.findParam({ detalle: "", cantidad: 1, fecha_venta: fechaActual, valor_unitario: 0, valor_total: 0, valor_neto: 0, id_usuario: 0, id_prod: 1, id_suc: 1, id_stock: 1 })
      .then((res: any) => {
        res.map((a: any) => {
          if (a.id_estado == 4 || a.id_estado == 7 || a.id_estado == 8) {
            array.push(a)
          }
        })
        this.setState({ dataVentas: array })
        console.log(array);
      })
      ...
      <div className="fondoOP">
        ...
        <MaterialTable
          columns={[
            ...
            { title: 'Estado', field: 'id_estado', headerStyle: table.headerStyle, lookup: { 4: 'Generada', 7: 'Aceptada', 8: 'Despachada' } },
            {
            ...
            {this.state.venta != undefined ? this.state.venta.map((a: any) => {
              ...
              return (
                <div style={{ marginLeft: '0rem' }} className="ms-Grid-row">
                  ...
                  <div style={{marginTop: '2rem'}} className="ms-Grid-col ms-sm12 ms-md6 ms-lg2">
                    <Checkbox label=""
...

            {
              this.state.estadoPedido == 4 ?
                <div style={{ marginTop: '15rem' }} className="ms-Grid-row">
                  ...
                  <div className="ms-Grid-col ms-sm12 ms-md6 ms-lg2">
                    <div className="botoneraOP">
                      <PrimaryButton className="botones" text="Aceptar" disabled={false} onClick={() => { this.aprobar(7) }}></PrimaryButton>
                    </div>
                  </div>
                </div>
                :
                this.state.estadoPedido == 7 ?
                  <div style={{ marginTop: '15rem' }} className="ms-Grid-row">
                    <div className="ms-Grid-col ms-sm12 ms-md6 ms-lg2">
                      <div className="botoneraOP">
                        <PrimaryButton className="botones" text="Volver" disabled={false} onClick={() => { this.setState({ pedido: false }) }}></PrimaryButton>
                    ...
                    <div className="ms-Grid-col ms-sm12 ms-md6 ms-lg2">
                      <div className="botoneraOP">
                        <PrimaryButton className="botones" text="Despachar" disabled={false} onClick={() => { this.aprobar(8) }}></PrimaryButton>
                      </div>
                    </div>
                  </div>
                  : this.state.estadoPedido == 8 ?
                  <div style={{ marginTop: '15rem' }} className="ms-Grid-row">
                  <div className="ms-Grid-col ms-sm12 ms-md6 ms-lg2">
                      <div className="botoneraOP">
                          <PrimaryButton className="botones" text="Volver" disabled={false} onClick={() => { this.setState({pedido: false}) }}></PrimaryButton>
                  ...
                  <a className="aprobada">Esta orden de pedido a sido Despachada</a>
              </div>
                  : ""
            }
          </div>
...
export default HomeOrdenPedido;