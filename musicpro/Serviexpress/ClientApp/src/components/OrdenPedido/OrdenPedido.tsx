...
export class OrdenPedidoProps { }

export class OrdenPedidoState {
    fecha_emision!: Date;
...
export class OrdenPedido extends React.Component<OrdenPedidoProps, OrdenPedidoState>{
          ...
          <div className="fondoOP">
            ...
            <div className="ms-Grid-col ms-sm6 ms-md6 ms-lg3">
                <ComboBox
                    ...
                    selectedKey={this.state.proveedor}
                    defaultSelectedKey={this.state.proveedor}
            ...
            <br></br>
              <div className="ms-Grid-col ms-sm12 ms-md12 ms-lg12 mt-12">
                ...
                <div className="ms-Grid-col ms-sm12 ms-md6 ms-lg2">  
                    ...
                    <PrimaryButton className="botones" text="Generar Orden" disabled={false} onClick={() => { this.guardarOrden() }}></PrimaryButton>
                    </div>
                </div>
                </div>
