...
const DayPickerStrings: IDatePickerStrings = {
  ...
  export class NotaCreditoProps { }

  export class NotaCreditoState {
    res_info!: Reserva;
    idBoleta: string = "";
  ...
  export class NotaCredito extends React.Component<NotaCreditoProps, NotaCreditoState>{
    ...
    private async obtenerReserva(res_id : number) {
        ...
        fetchEngine.getAPI("/api/GetReservaPorID/"+ res_id, {
          ...
          if (result.length > 0) {
            ...
            this.setState({fechaEmision: this._onFormatDate(new Date()).toString()})
        ...
        return (
          <Dialog
            ...
            dialogContentProps={{
              ...
              title: 'NotaCredito generada',
              subText: `La NotaCredito se a generado correctamente`
            }}
            modalProps={{
              isBlocking: true,
        ...
        return (
          <Dialog
            ...
            dialogContentProps={{
              type: DialogType.largeHeader,
              title: 'Error',
              subText: `A ocurrido un error al generar la Nota de Credito`
            }}
            modalProps={{
              isBlocking: true,
              styles: { main: { maxWidth: 450 } }
    ...
    public dialogoConfirmacion() {
        return (
          <Dialog
            ...
            dialogContentProps={{
              type: DialogType.largeHeader,
              title: 'Generar NotaCredito',
              subText: `¿Está seguro que desea generar la NotaCredito?`
            }}
            modalProps={{
              isBlocking: true,
              styles: { main: { maxWidth: 450 } }
    ...
    public dialogoConfirmacionAnular() {
        return (
          <Dialog
            ...
            dialogContentProps={{
              type: DialogType.largeHeader,
              title: 'Anular NotaCredito',
              subText: `¿Está seguro que desea anular la NotaCredito?`
            }}
            modalProps={{
              isBlocking: true,
              styles: { main: { maxWidth: 450 } }
            ...
            <div className="ms-Grid" dir="ltr">
                <div className="ms-Grid-row">
                    ...
                    <div className="ms-Grid-col ms-sm4 ms-md4 ms-lg4">
                        <h1 className={"textoNota"}>NOTA DE CREDITO</h1>
                    </div>
                    <div className="ms-Grid-col ms-sm8 ms-md8 ms-lg8">
                    </div>
                    <div className="ms-Grid-col ms-sm2 ms-md2 ms-lg2">
                        <div className={"fondonota"}>
                            <h4>N° NOTA DE CREDITO</h4>
                        </div>
                    </div>
                    <div className="ms-Grid-col ms-sm2 ms-md2 ms-lg2">
                        <div className={"fondonota"}>
                ...
                <div className="bordeAbajo">
                    ...
                    <div className="ms-Grid-col ms-sm12 ms-md1 ms-lg12">
                        <div className={"botonera"}>
                            <DefaultButton text="Volver" onClick={() => { window.location.href = `/documento_pago`; }}></DefaultButton>
                        </div>
                    </div>
